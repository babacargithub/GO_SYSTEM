...
use GO\SMSBundle\Entity\Formule;
use GO\SMSBundle\Form\FormuleType;
...
class FormuleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GOSMSBundle:Formule')->findAll();
     ...
     *
     * @Route("/", name="formule_create")
     * @Method("POST")
     * @Template("GOSMSBundle:Formule:new.html.twig")
     */
    public function createAction(Request $request)
    {
        $entity  = new Formule();
        $form = $this->createForm(new FormuleType(), $entity);
        $form->bind($request);
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GOSMSBundle:Formule')->find($id);
    ...
    public function editAction($id)
    {
        ...
        $editForm = $this->createForm(new FormuleType(), $entity);
        $deleteForm = $this->createDeleteForm($id);
     ...
     *
     * @Route("/{id}", name="formule_update")
     * @Method("PUT")
     * @Template("GOSMSBundle:Formule:edit.html.twig")
     */
