...
class FormationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('@App/formation/index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('@App/formation/new.html.twig', array(
            'formation' => $formation,
    ...
    public function showAction(Formation $formation)
    {
        ...
        return $this->render('@App/formation/show.html.twig', array(
            'formation' => $formation,
    ...
    public function editAction(Request $request, Formation $formation)
    {
        ...
        return $this->render('@App/formation/edit.html.twig', array(
            'formation' => $formation,
